...
async function testConnection() {
  ...
  const user = process.env.DB_USER || 'u859202671_pmf_circle_us';
  const password = process.env.DB_PASSWORD || 'Welcome_2026@';
  const database = process.env.DB_NAME || 'u859202671_pmf_circle_its';
